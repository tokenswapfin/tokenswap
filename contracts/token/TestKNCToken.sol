...
abstract contract ERC20KNC is ERC20Basic {
...
contract StandardToken is ERC20KNC, BasicToken {
  using SafeMath for uint256;
...
contract KyberNetworkCrystal is StandardToken, Ownable {
    using SafeMath for uint256;
    string  public  name = "Kyber Network Crystal";
    ...
    constructor ( uint tokenTotalAmount, uint startTime, uint endTime) {
    ...
    function emergencyERC20Drain( ERC20KNC token, uint amount ) public onlyOwner {
